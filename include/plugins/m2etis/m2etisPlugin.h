...
#ifndef __SPC_PLUGINS_M2ETIS_H__
#define __SPC_PLUGINS_M2ETIS_H__
...
typedef std::vector<uint8_t> SPC_EventType;
...
namespace plugins {
	...
	class m2etisSocketPlugin : public QObject, public plugins::SocketPluginInterface, public m2etis::pubsub::DeliverCallbackInterface {
		Q_OBJECT
	...
	private:
		/**
		 * \brief pubsubsystem of m2etis handling all of the network stuff
		 */
		m2etis::pubsub::PubSubSystem * _pubSubSystem;
		...
		/**
		 * \brief method of m2etis::pubsub::DeliverCallbackInterface, here received messages arrive
		 */
		void deliverCallback(const m2etis::message::M2Message<SPC_EventType>::Ptr m) override;
	};

} /* namespace plugins */
} /* namespace spc */

#endif /* __SPC_PLUGINS_M2ETIS_H__ */
