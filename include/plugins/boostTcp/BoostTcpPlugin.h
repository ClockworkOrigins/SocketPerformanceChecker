...
#ifndef __SPC_PLUGINS_BOOSTTCP_H__
#define __SPC_PLUGINS_BOOSTTCP_H__
...
namespace plugins {
	...
	private:
		 ...
		 */
		boost::asio::ip::tcp::socket * _testSocket;
		...
		/**
		 * \brief method to read from a socket automatically
		 */
		void readFromSocket();
	};
...
#endif /* __SPC_PLUGINS_BOOSTTCP_H__ */
