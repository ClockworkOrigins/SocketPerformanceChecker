...
#ifndef __SPC_PLUGINS_QTUDP_H__
#define __SPC_PLUGINS_QTUDP_H__
...
namespace plugins {
	...
	class QtUdpSocketPlugin : public QObject, public plugins::SocketPluginInterface {
		Q_OBJECT
