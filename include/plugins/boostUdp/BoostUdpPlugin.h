...
#ifndef __SPC_PLUGINS_BOOSTUDP_H__
#define __SPC_PLUGINS_BOOSTUDP_H__
...
namespace plugins {
	...
	class BoostUdpSocketPlugin : public QObject, public plugins::SocketPluginInterface {
		Q_OBJECT
	...
	private:
		 ...
		 */
		boost::asio::ip::udp::socket * _testSocket;
		 ...
		 */
		void handleReceive(const boost::system::error_code & e, size_t len, boost::asio::ip::udp::endpoint * remoteEndpoint);
	};

} /* namespace plugins */
} /* namespace spc */

#endif /* __SPC_PLUGINS_BOOSTUDP_H__ */
